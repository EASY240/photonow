...
const ShareButtons: React.FC<ShareButtonsProps> = ({ 
  ...
  const shareData = [
    ...
    {
      name: 'Pinterest',
      url: `https://pinterest.com/pin/create/button/?url=${encodeURIComponent(currentUrl)}&description=${encodeURIComponent(currentTitle)}&media=${encodeURIComponent(currentUrl)}`,
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
